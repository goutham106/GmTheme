...
class ThemeLayoutInflater : LayoutInflater {
    ...
    var viewFactory: ThemeViewFactory? = null
    var decorators: Array<ThemeDecorator>? = null

    override fun cloneInContext(newContext: Context): LayoutInflater {
        val inflater = ThemeLayoutInflater(this, newContext, true)
    ...
    /**
     * Method to dispatch our view and attributes to the [ThemeViewFactory].
     * Called immediately after [onCreateView][ThemeLayoutInflater.onCreateView]
     *
     * @param view
    ...
    private class WrapperFactory internal constructor(
        private val inflater: ThemeLayoutInflater,
    ...
    private open class WrapperFactory2 internal constructor(
        internal val inflater: ThemeLayoutInflater,
    ...
    private class PrivateWrapperFactory2 internal constructor(
        inflater: ThemeLayoutInflater, factory: LayoutInflater.Factory2
    ...
    companion object {
        ...
        internal var inflationDelegate: ThemeInflationDelegate? = null
    }
