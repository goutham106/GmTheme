 ...
 *     EdgeEffectTint(activity).tint(ContextCompat.getColor(activity, R.color.gm_primary))
 * }
 * ```
 */
    ...
    companion object {
        ...
        fun setEdgeEffectColor(edgeEffect: EdgeEffect, @ColorInt color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge effect color", e)
            }
        }
        ...
        private fun setEdgeGlowColor(scrollView: NestedScrollView, @ColorInt color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge glow color on NestedScrollView", e)
            }
        }
        ...
        private fun setEdgeGlowColor(hsv: HorizontalScrollView, @ColorInt color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge glow color on HorizontalScrollView", e)
            }
        }
        ...
        private fun setEdgeGlowColor(scrollView: ScrollView, color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge glow color on ScrollView", e)
            }
        }
        ...
        private fun setEdgeGlowColor(viewPager: ViewPager, color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge glow color on ViewPager", e)
            }
        }
        ...
        private fun setEdgeGlowColor(webView: WebView, color: Int) {
            try {
                ...
                Theme.log(TAG, "Error setting edge glow color on WebView", e)
            }
        }
